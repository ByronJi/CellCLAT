...
from semiSupervised.evaluate_embedding import evaluate_embedding, semi_evaluate_embedding
from semiSupervised.mask_generator import MaskSimclr, FeatureMask, SampleSelector
...
if __name__ == "__main__":
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 5 == 0:
            ...
            # if epoch == 20:
            #     np.save("cwn-ssl-gumbel_emb.npy", emb)
            #     np.save("cwn-ssl-gumbel_y.npy", y)
            acc_val, acc = semi_evaluate_embedding(emb, y, search=True, label_ratio=0.1)
